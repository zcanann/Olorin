...
- [x] Upgrade remaining pinned/high-friction dependencies (`bincode`, `rodio`, `slint`, `windows-sys`, `zip`) and resolve breakages.
...
- Upgraded all direct `sysinfo` constraints from `=0.34.2` to `>=0.37.2`; lockfile currently resolves to `sysinfo v0.38.0` under Rust 1.90 nightly constraints.
